...
import FixtureMatches from '@/components/matches/FixtureMatches';
import { AvatarImage, BackButton, Card } from '@/components/ui';
import { useMemberDataAndStats } from '@/hooks/useMembers';
...
function MemberStats({ stats }: { stats?: StatsType }) {
  const topRowStats = [
    {
      label: 'Predictions',
