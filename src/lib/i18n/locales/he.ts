...
export const he = {
    ...
    admin: {
      ...
      'Showing {{count}} members in {{league}}.': 'מוצגים {{count}} משתתפים בליגה {{league}}.',
      ...
      'Search predictions by user, league, or fixture...': 'חיפוש לפי משתמש, ליגה או מזהה משחק...',
      ...
      'Audit recent predictions submitted by users.': 'בדיקת ניחושים שנשלחו על ידי המשתמשים.',
      ...
      'Search competitions by name, area, or code...': 'חיפוש לפי שם תחרות, אזור או קוד...',
      ...
      'Add or remove competitions from the platform.': 'הוספת או הסרת תחרויות מהמערכת.',
