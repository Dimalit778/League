...
export const he = {
  ...
  matches: {
    ...
    "AI prediction": "ניבוי AI",
    "AI Match Analysis": "ניתוח משחק AI",
    "Powered by AI": "מבוסס AI",
    "Match Summary": "סיכום המשחק",
    "AI Summary": "סיכום AI",
  ...
  status: {
    ...
    PAUSED: "מחצית",
    EXTRA_TIME: "הארכה",
    PENALTY_SHOOTOUT: "פנדלים",
    SUSPENDED: "הופסק זמנית",
    POSTPONED: "נדחה",
    CANCELLED: "בוטל",
    AWARDED: "הוכרע מנהלתית",
    Pending: "ממתין",
    Bingo: "בינגו",
    Hit: "פגיעה",
    Miss: "פספוס",
