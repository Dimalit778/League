...
export const en = {
  ...
  leagues: {
    ...
    "Deleting a league cannot be undone.":
      "Deleting a league cannot be undone.",
    "You will lose access to this league.":
      "You will lose access to this league.",
    "Save changes": "Save changes",
    "That's the whole leaderboard for now":
      "That's the whole leaderboard for now",
  ...
  admin: {
    ...
    "Choose an area to review or manage.":
      "Choose an area to review or manage.",
    People: "People",
    Activity: "Activity",
    Safety: "Safety",
    ...
    "Try a competition name, area, or code.":
      "Try a competition name, area, or code.",
