      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              style={[styles.input, emailError ? styles.inputError : null, email ? styles.inputFilled : null]}
              value={email}
          ...
          <TouchableOpacity
            style={[styles.primaryButton, !isFormValid || loading ? styles.primaryButtonDisabled : null]}
