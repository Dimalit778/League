...
const TopThreeSkeleton = () => {
  return (
    <View className="mx-3 mb-3 overflow-hidden rounded-2xl border border-border bg-surface p-4">
      <Skeleton style={{ width: 60, height: 14, marginBottom: 16, borderRadius: 4 }} />
      <View className="flex-row items-end justify-center gap-3">
        <View className="flex-1 items-center">
          <Skeleton style={{ width: 58, height: 58, borderRadius: 29, marginBottom: 24 }} />
          <Skeleton style={{ width: 64, height: 12, borderRadius: 4 }} />
        </View>
        <View className="flex-1 items-center -mt-4">
          <Skeleton style={{ width: 72, height: 72, borderRadius: 36, marginBottom: 24 }} />
          <Skeleton style={{ width: 72, height: 12, borderRadius: 4 }} />
        </View>
        <View className="flex-1 items-center">
          <Skeleton style={{ width: 58, height: 58, borderRadius: 29, marginBottom: 24 }} />
          <Skeleton style={{ width: 64, height: 12, borderRadius: 4 }} />
...
const LeaderboardCardSkeleton = () => {
  return (
    <View className="mx-3 mb-1.5 flex-row items-center rounded-xl bg-[#0D1524] px-2 py-2.5">
      <Skeleton style={{ width: 16, height: 14, borderRadius: 4 }} />
      ...
      <Skeleton style={{ width: 48, height: 14, borderRadius: 4, marginLeft: 8 }} />
      <Skeleton style={{ width: 24, height: 14, borderRadius: 4, marginLeft: 8 }} />
      <Skeleton style={{ width: 16, height: 14, borderRadius: 4, marginLeft: 8 }} />
    </View>
  );
};
        ...
        <View className="flex-row items-center justify-between">
          {Array.from({ length: 3 }).map((_, i) => (
            <View key={i} className="flex-1 items-center">
              <Skeleton style={{ width: 40, height: 20, borderRadius: 4, marginBottom: 4 }} />
              <Skeleton style={{ width: 56, height: 10, borderRadius: 4 }} />
            </View>
          ))}
        </View>
      </View>
