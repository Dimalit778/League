    ...
    <View className="flex-1 ">
      <View className="mx-4 flex-row items-center justify-between rounded-2xl border border-border bg-surface py-3">
        <View className="flex-1 items-center justify-center">
          ...
          <Text variant="caption" className="mt-1 uppercase tracking-wide text-muted">{t('Rank')}</Text>
        ...
        <View className="flex-1 items-center justify-center">
          ...
          <Text variant="caption" className="mt-1 uppercase tracking-wide text-muted">{t('Total Points')}</Text>
