  ...
  return (
    <Screen>
      ...
      >
        ...
        {/* Hero card */}
        <View className="mx-3 mt-1 rounded-3xl border border-border bg-surface p-4">
          ...
          <View className="mt-5 flex-row rounded-2xl border border-border bg-background/60 p-3">
        ...
        <View className="mx-3 mt-4 flex-row gap-2">
          ...
          <View className="flex-1 gap-2">
            <View className="flex-1 flex-row gap-2">
              <View className="flex-1 rounded-xl border border-border bg-surface p-2.5">
        ...
        {/* Best category */}
        <View className="mx-3 mt-5 rounded-2xl border border-border bg-surface p-4 flex-row items-center">
