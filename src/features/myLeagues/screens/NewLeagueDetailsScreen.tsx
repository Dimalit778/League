import { useCreateLeague } from "@/features/myLeagues/hooks/useLeagues";
...
export default function NewLeagueDetailsScreen() {
  ...
  const onSubmit = async (data: { leagueName: string; nickname: string }) => {
    ...
    //   if (leagueData) {
    //     router.push({
    //       pathname: "/(app)/myLeagues/createLeague/league-created",
