...
export const MatchFinished = ({
  ...
  <View className="space-y-4">
    {/* Final Result */}
    <LinearGradient colors={["#10B981", "#059669"]} className="rounded-2xl p-6">
      <View className="flex-row items-center mb-4">
        <View className="w-10 h-10 bg-white/20 rounded-full items-center justify-center">
          <Ionicons name="trophy" size={20} color="white" />
        </View>
        <Text className="text-white text-xl font-bold ml-3">Final Result</Text>
      </View>
      ...
      <View className="bg-surface rounded-2xl p-6">
        ...
        <View className="flex-row items-center justify-between">
          <View className="items-center">
            <Text className="text-textMuted text-sm mb-1">Your Prediction</Text>
